...
def UploadAction(event=None):
    ...
    if common_key[:2] == "d7" and len(common_key) == 32:
        ...
        button2.grid(padx=7, column=2, row=1, sticky="w")
    else:
